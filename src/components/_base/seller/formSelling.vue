                ...
                <div class="row ">
                    <div class="col-8">
                        <form>
                            <div class="form">
                                <div class="col mb-3">
                                    <label class="col-4 text-left">Name of goods</label>
                                    <input v-model="name" type="text" class="form-control form-control-lg my-auto col" id="validationDefault01" required>
                                </div>
                            </div>
                        </form>
                    </div>
